...
class Bitboard():
    ...
    def __init_mask__(self):
        ...
        self.U1_mask = 0b0000000011111111111111111111111111111111111111111111111111111111
        self.D1_mask = 0b1111111111111111111111111111111111111111111111111111111100000000
